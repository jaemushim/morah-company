...
window.jQuery &&
    (function (d) {
        ...
        function h(e) {
            return (
                (e.files && e.files.length ? e.files : null) || [
                    {
                        name: e.value,
                        size: 0,
        ...
        (d.fn.MultiFile = function (e) {
            ...
            if ('string' == typeof arguments[0]) {
                ...
                return d.fn.MultiFile[arguments[0]].apply(
                    this,
            ...
            d('form')
                ...
                .submit(d.fn.MultiFile.disableEmpty),
                d.fn.MultiFile.options.autoIntercept &&
                    (d.fn.MultiFile.intercept(d.fn.MultiFile.options.autoIntercept),
                    ...
                    .each(function () {
                        ...
                        var i = window.MultiFile,
                            ...
                            p = d.extend(
                                ...
                                e || {},
                                (d.metadata ? f.E.metadata() : d.meta ? f.E.data() : null) || {},
                                {}
                            );
                        0 < p.max || (p.max = f.E.attr('maxlength')),
                            0 < p.max ||
                                ...
                                0 < p.max
                                    ? (p.max = String(p.max).match(/[0-9]+/gi)[0])
                                    : (p.max = -1)),
                            (p.max = new Number(p.max)),
                            (p.accept = p.accept || f.E.attr('accept') || ''),
                            p.accept ||
                                ((p.accept = f.e.className.match(/\b(accept\-[\w\|]+)\b/gi) || ''),
                            ...
                            0 < p.maxsize ||
                                ...
                                0 < p.maxsize
                                    ? (p.maxsize = String(p.maxsize).match(/[0-9]+/gi)[0])
                                    : (p.maxsize = -1)),
                            ...
                            0 < p.maxfile ||
                                ...
                                0 < p.maxfile
                                    ? (p.maxfile = String(p.maxfile).match(/[0-9]+/gi)[0])
                                    : (p.maxfile = -1)),
                            ...
                            1 < String(f.accept).length &&
                                ((f.accept = f.accept.replace(/\W+/g, '|').replace(/^\W|\W$/g, '')),
                            ...
                            f.list ||
                                (f.wrapper.append(
                                    '<div class="MultiFile-list" id="' + f.wrapID + '_list"></div>'
                                ),
                                ...
                                f.n++,
                                    ...
                                    u.change(function (e, i, t) {
                                        ...
                                        d.each(l, function (e, i) {
                                            ...
                                            0 < f.max &&
                                                a.length + l.length > f.max &&
                                                ((o[o.length] = f.STRING.toomany.replace(
                                                    '$max',
                                                    f.max
                                                )),
                                            ...
                                            0 < f.maxsize &&
                                                c > f.maxsize &&
                                                ((o[o.length] = f.STRING.toomuch.replace(
                                                    '$size',
                                                    g(c) + ' > ' + g(f.maxsize)
                                                )),
                                                f.trigger('FileTooMuch', this, f, n));
                                        var p = d(f.clone).clone();
                                        if ((p.addClass('MultiFile'), 0 < o.length))
                                            return (
                                                f.error(o.join('\n\n')),
                                                f.n--,
                                                f.addSlave(p[0], m),
                                    ...
                                    var i = String(t.name || '').replace(/[&<>'"]/g, function (e) {
                                        ...
                                        s = d(
                                            (
                                                ...
                                                l +
                                                '</span>' +
                                                (f.preview || d(c).is('.with-preview') ? r : '') +
                                                '</span>'
                                            )
                                                .replace(
                                                    /\$(file|name)/gi,
            ...
            d.extend(d.fn.MultiFile, {
                ...
                disableEmpty: function (e) {
                    ...
                    return (
                        ...
                        (d.fn.MultiFile.reEnableTimeout = window.setTimeout(
                ...
                intercept: function (e, i, t) {
                    var a, l;
                    if (
                        ((t = t || []).constructor.toString().indexOf('Array') < 0 && (t = [t]),
                        'function' == typeof e)
                    )
                        return (
                            ...
                            (function (e) {
                                (d.fn.MultiFile.intercepted[e] = d.fn[e] || function () {}),
                                    (d.fn[e] = function () {
                                        return (
                                            d.fn.MultiFile.disableEmpty(),
                                            (l = d.fn.MultiFile.intercepted[e].apply(
                                                this,
                                                arguments
                                            )),
                                            setTimeout(function () {
            ...
            (d.fn.MultiFile.options = {
                ...
                STRING: {
                    ...
                    file: '$file',
                    selected: '선택된 파일: $file',
                    duplicate: 'This file has already been selected:\n$file',
                    toomuch: '파일 용량이 너무 큽니다. (최대 : $size)',
                    toomany: '파일 1~4개까지 첨부 가능합니다. (최대 : $max)',
